...
public class EmailController {
    ...
    public String sendSimpleEmail() {
        try {
            ...
            message.setTo("2379994972@qq.com"); // 接收地址
    ...
    public String sendHtmlEmail() {
        ...
        try {
            ...
            helper.setFrom(from);
            helper.setTo("2379994972@qq.com"); // 接收地址
    ...
    public String sendAttachmentsMail() {
        ...
        try {
            ...
            // 传入附件
            FileSystemResource file = new FileSystemResource(new File("_15.spring-boot-email/src/main/resources/static/file/项目文档.docx"));
    ...
    public String sendInlineMail() {
        ...
        try {
            ...
            // 传入附件
            FileSystemResource file = new FileSystemResource(new File("_15.spring-boot-email/src/main/resources/static/img/img.png"));
